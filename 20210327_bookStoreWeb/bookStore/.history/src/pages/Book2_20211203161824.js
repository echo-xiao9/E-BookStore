                ...
                <div className="w3-row">
                    ...
                    <div className="w3-col l8 s12">
                                ...
                                <div className="w3-row">
                                    <div className="w3-col m8 s12">
                                        <p>
                                            ...
                                            <button className="w3-button w3-white w3-border"><b>Add to cart »</b>
                                            </button>
                                        </p>
                                    </div>
                        ...
                        <div className="w3-card-4 w3-margin w3-white">
                            ...
                            <div className="w3-container">
                                <h7>
                                    J.K. Rowling is the author of the seven Harry Potter books, first published between
                                    1997 and 2007. The adventures of Harry,
                                    Ron, and Hermione at Hogwarts School of Witchcraft and Wizardry have sold over 500
                                    million copies, been translated into over
                                    80 languages, and made into eight blockbuster films. Alongside the book series, she
                                    has written three short companion volumes
                                    for charity, including Fantastic Beasts and Where to Find Them, which later became
                                    the inspiration for a new series of films,
                                    also written by J.K. Rowling. She then continued Harry’s story as a grown-up in a
                                    stage play, Harry Potter and the Cursed Child,
                                    which she wrote with playwright Jack Thorne and director John Tiffany, and which has
                                    been playing to great acclaim in theatres
                                    in Europe, North America, and Australia.
                                    J.K. Rowling has received many awards and honors for her writing. She also supports
                                    a number of causes through her charitable trust, Volant,
                                    and is the founder of the children’s charity Lumos, which fights for a world without
                                    orphanages and institutions, and reunites families.
                                    For as long as she can remember, J.K. Rowling has wanted to be a writer, and is at
                                    her happiest in a room, making things up. She lives in Scotland
                                    with her family.
                                </h7>
                                <div className="w3-row">
                                    <div className="w3-col m8 s12">
                    ...
                    <div className="w3-col l4">
                        ...
                        <div className="w3-card w3-margin">
                            ...
                            <ul className="w3-ul w3-hoverable w3-white">
                                <li className="w3-padding-16">
                                    <img src="images/harry2.jpg" alt="Image" className="w3-left w3-margin-right"
                                         style={{width: '50px'}}/>
                        ...
                        <div className="w3-card w3-margin">
                            ...
                            <div className="w3-container w3-white">
                <span><h5 className="w3-tag w3-black w3-small w3-margin-bottom">Fiction</h5> <span
                    className="w3-tag w3-light-grey w3-small w3-margin-bottom">Adventure</span> <span
                    className="w3-tag w3-light-grey w3-small w3-margin-bottom">Magic</span>
                  <span className="w3-tag w3-light-grey w3-small w3-margin-bottom">Children's literature</span> <span
                        className="w3-tag w3-light-grey w3-small w3-margin-bottom">Classics</span> <span
                        className="w3-tag w3-light-grey w3-small w3-margin-bottom">England</span>
