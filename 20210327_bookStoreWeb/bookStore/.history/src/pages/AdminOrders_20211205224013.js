...
export default class Orders extends React.Component {
    ...
    constructor(props) {
        ...
        const url = "http://localhost:9091/getOrders";
    ...
    processData() {
        this.state.orders.map((line) => {
            ...
            axios({
                method: 'GET',
                url: 'http://localhost:9091/getOrderItem',
                params: {
    ...
    search = () => {
        ...
        axios({
            method: 'GET',
            url: 'http://localhost:9091/getAdminBookOrders',
            params: {
                bookName: this.state.bookName
            }
        }).then(response => {
    ...
    dateSelectBook = () => {
        ...
        axios({
            method: 'GET',
            url: 'http://localhost:9091/getAdminDateOrder',
            params: {
                from: newFrom,
                to: newTo
            }
