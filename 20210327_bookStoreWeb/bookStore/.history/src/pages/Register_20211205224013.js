...
export default class Register extends React.Component {
    ...
    checkUsername() {
        axios({
            method: 'GET',
            url: "http://localhost:9091/getUserByName",
            params: {
                    ...
                    <div class="card">
                        ...
                        <form class="card-form">
                            ...
                            <div class="input">
                                ...
                                <input type="password" id="register" class="input-field" required
                                       onChange={this.handlePsw2Change}/>
                                <label class="input-label">Input password again</label>
                            </div>
                            {this.checkMatch()}
                            <div class="action">
                                <Button buttonStyle='btn--blackBG' onClick={this.registerButtonClicked}>Get
                                    started</Button>
                            </div>
